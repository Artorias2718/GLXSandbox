...
bool Tools::AssetBuildLibrary::UtilityFunctions::ConvertSourceRelativePathToBuiltRelativePath(const char* const i_sourceRelativePath, const char* const i_assetType,
...
bool Tools::AssetBuildLibrary::UtilityFunctions::GetAssetBuildSystemPath(std::string& o_path, std::string* const o_errorMessage)
{
	std::string scriptDir;
	if (Engine::Platform::GetEnvironmentVariable("ScriptDir", scriptDir, o_errorMessage))
	{
...
void Tools::AssetBuildLibrary::UtilityFunctions::OutputErrorMessage(const char* const i_errorMessage, const char* const i_optionalFileName)
{
