...
bool Engine::Windows::Functions::CopyFile(const char* const i_path_source, const char* const i_path_target,
...
bool Engine::Windows::Functions::CreateDirectoryIfNecessary(const std::string& i_path, std::string* const o_errorMessage)
{
...
bool Engine::Windows::Functions::DoesFileExist(const char* const i_path, std::string* const o_errorMessage)
{
...
bool Engine::Windows::Functions::ExecuteCommand(const char* const i_command, DWORD* const o_exitCode, std::string* const o_errorMessage)
{
	return ExecuteCommand(NULL, i_command, o_exitCode, o_errorMessage);
}

bool Engine::Windows::Functions::ExecuteCommand(const char* const i_path, const char* const i_optionalArguments,
...
bool Engine::Windows::Functions::GetEnvironmentVariable(const char* const i_key, std::string& o_value, std::string* const o_errorMessage)
{
	// Windows requires a character buffer
...
std::string Engine::Windows::Functions::GetFormattedSystemMessage(const DWORD i_code)
{
...
std::string Engine::Windows::Functions::GetLastSystemError(DWORD* const o_optionalErrorCode)
{
...
bool Engine::Windows::Functions::GetLastWriteTime(const char* const i_path, uint64_t& o_lastWriteTime, std::string* const o_errorMessage)
{
...
bool Engine::Windows::Functions::InvalidateLastWriteTime(const char* const i_path, std::string* const o_errorMessage)
{
	bool wereThereErrors = false;
...
bool Engine::Windows::Functions::LoadBinaryFile(const char* const i_path, sDataFromFile& o_data, std::string* const o_errorMessage)
{
	bool wereThereErrors = false;
	...
	HANDLE fileHandle = INVALID_HANDLE_VALUE;
	{
		...
		if (fileHandle == INVALID_HANDLE_VALUE)
		{
			...
			if (o_errorMessage)
			{
				const std::string windowsError = Engine::Windows::Functions::GetLastSystemError();
				std::ostringstream errorMessage;
...
bool Engine::Windows::Functions::WriteBinaryFile(const char* const i_path, const void* const i_data, const size_t i_size, std::string* const o_errorMessage)
{
	bool wereThereErrors = false;
