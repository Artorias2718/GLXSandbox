...
Engine::Graphics::Assets::Debug::cLine::cLine(const glm::vec3& i_startPosition, const glm::vec3& i_endPosition, const Engine::Graphics::Structures::sColor8& i_color)
{
...
bool Engine::Graphics::Assets::Debug::cLine::SetPosition(int i_idx, const glm::vec3& i_position)
{
