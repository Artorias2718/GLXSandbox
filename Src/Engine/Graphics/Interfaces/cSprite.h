	...
	namespace Graphics
	{
		namespace Interfaces 
		{
			...
			public:
				...
				cSprite(
					const Structures::sRectangle& i_screenPosition = { -1.0f, 1.0f, 1.0f, -1.0f },
					const Structures::sRectangle& i_texturePosition = { 0.0f, 1.0f, 1.0f, 0.0f },
				...
				Structures::sRectangle m_screenPosition;
				Structures::sRectangle m_texturePosition;
