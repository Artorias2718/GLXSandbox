...
Engine::Shared::cGameObject* Engine::Shared::cDebugMenu::DebugSphere()
{
	return m_debugSphere;
}
#endif
...
bool Engine::Shared::cDebugMenu::Render()
{
	...
	m_debugSphere->m_transform.scale = m_scaleSphereVal * glm::vec3(1.0f, 1.0f, 1.0f);
