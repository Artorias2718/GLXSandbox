...
#ifndef ENGINE_APPLICATION_WINDOWS_CBASEAPPLICATION_WIN_H
#define ENGINE_APPLICATION_WINDOWS_CBASEAPPLICATION_WIN_H
...
protected:
	...
	static cBaseApplication* GetApplicationFromWindow( const HWND i_window );
...
#endif	// !ENGINE_APPLICATION_WINDOWS_CBASEAPPLICATION_WIN_H
