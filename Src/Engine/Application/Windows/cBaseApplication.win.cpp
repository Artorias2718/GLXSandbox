...
bool Engine::Application::cBaseApplication::Initialize_base( const sEntryPointParameters& i_entryPointParameters )
{
...
bool Engine::Application::cBaseApplication::CleanUp_base()
{
	bool wereThereErrors = false;
