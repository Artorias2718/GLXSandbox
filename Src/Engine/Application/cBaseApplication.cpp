...
int Engine::Application::cBaseApplication::ParseEntryPointParametersAndRun( const sEntryPointParameters& i_entryPointParameters )
{
	int exitCode = EXIT_SUCCESS;

	// Initialize the application
	if ( InitializeAll( i_entryPointParameters ) )
	{
...
bool Engine::Application::cBaseApplication::InitializeAll( const sEntryPointParameters& i_entryPointParameters )
{
	...
	if ( !InitializeBase( i_entryPointParameters ) )
	{
		ASSERT( false );
		return false;
	}
...
bool Engine::Application::cBaseApplication::InitializeEngine()
{
	// User Output
	{
...
bool Engine::Application::cBaseApplication::CleanUpAll()
{
...
bool Engine::Application::cBaseApplication::CleanUpEngine()
{
	bool wereThereErrors = false;
...
void Engine::Application::cBaseApplication::OnNewFrame()
{
	Time::OnNewFrame();
