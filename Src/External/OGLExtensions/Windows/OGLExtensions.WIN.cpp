...
#define OGLEXTENSIONS_LOADFUNCTION( i_functionName, i_functionType )														\
	...
	OGLEXTENSIONS_LOADFUNCTION(glBlendEquation, PFNGLBLENDEQUATIONPROC);
	OGLEXTENSIONS_LOADFUNCTION(glBlendEquationSeparate, PFNGLBLENDEQUATIONSEPARATEPROC);
	OGLEXTENSIONS_LOADFUNCTION(glBlendFuncSeparate, PFNGLBLENDFUNCSEPARATEPROC);
	...
	OGLEXTENSIONS_LOADFUNCTION(glDrawElementsBaseVertex, PFNGLDRAWELEMENTSBASEVERTEXPROC);
	...
	OGLEXTENSIONS_LOADFUNCTION(glDetachShader, PFNGLDETACHSHADERPROC);
	...
	OGLEXTENSIONS_LOADFUNCTION(glGetAttribLocation, PFNGLGETATTRIBLOCATIONPROC);
	...
	OGLEXTENSIONS_LOADFUNCTION(glGetStringi, PFNGLGETSTRINGIPROC);
	OGLEXTENSIONS_LOADFUNCTION(glGetUniformLocation, PFNGLGETUNIFORMLOCATIONPROC);
	OGLEXTENSIONS_LOADFUNCTION(glInvalidateBufferData, PFNGLINVALIDATEBUFFERDATAPROC);
