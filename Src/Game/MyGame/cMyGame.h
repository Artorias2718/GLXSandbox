...
#ifndef GAME_MYGAME_CMYGAME_H
#define GAME_MYGAME_CMYGAME_H
...
namespace Game
{
	namespace MyGame
	{
		class cMyGame : public Engine::Application::cBaseApplication
		{
			// Interface
			//==========
		...
		private:
			...
			virtual const char* GetPathToLogTo() const { return "MyGame.log"; }
#if defined( WINDOWS_API )
